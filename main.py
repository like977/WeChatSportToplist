...
min_dict = {time_list[0]: 0, time_list[1]: 5800, time_list[2]: 8000, time_list[3]: 15800, time_list[4]: 19000, time_list[5]: 26000, time_list[6]: 29000}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 3000, time_list[1]: 7000, time_list[2]: 12000, time_list[3]: 17999, time_list[4]: 24000, time_list[5]: 28999, time_list[6]: 36999}
# 设置结束
